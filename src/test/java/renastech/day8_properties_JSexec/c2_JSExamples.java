...
public class c2_JSExamples extends TestBase {
    ...
    public void TC1_handlingWindowWithJSExecuter(){
        ...
        jse.executeScript("window.location = 'http://www.google.com/'"); //blank olmadan yazarsan youtube sayfasini google'a cevirir
        jse.executeScript("window.open('http://facebook.com','_blank');");  //blank oldugunda yeni bir window acar.
    ...
    public void scroolDownWithJSExecuter(){
        ...
        js.executeScript("window.scrollBy(0,1000)"); //bu methodla, sayfayi actiginda sayfanin en altina goturuyor seni
